...
| --- | --- | --- |
| [Bootstrap Multiplayer Game Server](bootstrap-multiplayer-game-server/) | Available | Designs, scaffolds, or migrates a production-minded server-authoritative foundation for session-based multiplayer games without prematurely building a full MMO. |
...
| [Scaffold Personal Dashboard Site](scaffold-personal-dashboard-site/) | Available | Designs, scaffolds, or extends a modular personal dashboard for GPT Sites, Claude Code, and Claude Artifacts with verified source paths, failure isolation, and controlled publication. |
