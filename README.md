...
| [Scaffold Personal Dashboard Site](engineering/scaffold-personal-dashboard-site/) | Engineering | Designs, scaffolds, or extends modular personal dashboards for ChatGPT Sites while verifying source feasibility and preserving publication boundaries. |
...
| Scaffold Personal Dashboard Site | Only for repository-backed Scaffold or Extend work | No repository required for Blueprint or a local Sites workspace; publication requires a Sites-enabled host and separate authorization |
